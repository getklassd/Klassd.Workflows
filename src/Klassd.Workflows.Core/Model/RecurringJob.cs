...
public enum RecurringKind { Job, Workflow }

/// <summary>A cron-scheduled job or workflow registered through code.</summary>
public sealed class RecurringJob
{
    public string Id { get; set; } = "";
    public RecurringKind Kind { get; set; } = RecurringKind.Job;

    /// <summary>For <see cref="RecurringKind.Job"/>: the job type to enqueue.</summary>
